...
R1_S **←** **σ** <sub>( gênero="M" **AND** data_nascimento > 01/01/1981 **AND** data_nascimento < 01/01/1991 )</sub> ( Programador )
  
R2_P **←**  **π** <sub>nome_programador, email, id_startup</sub> ( R1_S )
  
R3_J **←** R1_S **⨝** <sub>( id_startup = id_startup )</sub> R2_P
  
R (Nome, Email, Startup) **←** **π** <sub>nome_programador, email, nome_startup</sub> ( R3_J )
...
R1_S **←**  **σ** <sub>gênero="F"</sub> ( Programador )
R2_Juncao_natural **←**  R1_S **| x |** Programador_Linguagem
R3_Juncao_natural **←** R3_Juncao_natural **| x |** Linguagem_Programacao
R(Programadora, Linguagem) **←** **π** <sub>nome_programador, nome_linguagem </sub> ( R3_Juncao_natural )
...
R1_S **←**  **σ** <sub>id_programador=30001</sub> ( Programador_Linguagem )
 R **←** **π** <sub>id_linguagem </sub> ( Linguagem_Programacao ) - **π** <sub>id_linguagem </sub> ( R1_S )
